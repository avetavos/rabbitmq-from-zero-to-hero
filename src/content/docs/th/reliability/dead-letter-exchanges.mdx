...
export const quizDlx = [
  {
    ...
    options: [
      'ลบ queue ทิ้ง',
      're-deliver message ทันที เกิดลูป poison message แน่น ๆ ที่ fail ซ้ำ ๆ',
      'ปิด acknowledgement',
      'ส่ง message ไปทุก consumer พร้อมกัน',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      'reject/nack แบบ requeue=false',
      'message TTL ของตัวเองหมดอายุใน queue',
