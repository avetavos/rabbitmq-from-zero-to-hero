...
export const quizRetry = [
  {
    ...
    options: [
      'ลบ message',
      'สร้าง tight poison loop ที่หมุนถี่และกระหน่ำ dependency ที่ล่มอยู่',
      'duplicate message ไปยังทุก consumer',
      'ปิด acknowledgement',
    ],
    answer: 1,
  },
  ...
  },
  {
    ...
    options: [
      ...
      'เพื่อ route ตาม topic',
      'เพื่อทำให้ message persistent',
    ],
    answer: 1,
  },
  {
