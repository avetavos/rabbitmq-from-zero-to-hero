...
export const quizCluster = [
  ...
  {
    q: 'What is the status of classic mirrored queues in current RabbitMQ?',
    options: [
      'The recommended default for HA',
      'Removed in RabbitMQ 4.0 — quorum queues replace them',
